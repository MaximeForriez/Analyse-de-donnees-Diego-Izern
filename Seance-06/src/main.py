...
#Fonction pour convertir les données en données log
...
#Fonction pour trier par ordre décroissant les listes
...
#Ordonner la liste obtenue avec la fonction locale ordreDecroissant()
